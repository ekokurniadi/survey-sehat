<div class="main-top clearfix" id="carouselForm">
    ...
    <div class="main-top__right">
        <div class="main-top__registration"><a href="<?php echo base_url('publics/register')?>" class="popup-show-register"><img src="<?php echo base_url() ?>image/default/images/common/user_img.png" alt="Mulai Menjab survei" height="72" width="72" /><span><strong>DAFTAR</strong><span class="registration__txt">Mulai Menjab survei</span></span></a></div>
        <div class="main-top__member" style="background: url('<?php echo base_url() ?>assetsPublic/application/templates/default/default/images/common/bg_01.gif') no-repeat scroll right top #0ea2d3;">
            <p>Total Anggota<br />Survey Sehat<span>743,121</span></p>
        </div>
    </div>
</div>
