        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <div class="col-md-4">
                <?php echo anchor(site_url('profil_perusahaan/create'), '<i class="fa fa-plus"></i> Add New', 'class="btn btn-icon icon-left btn-primary"'); ?>
              </div>
                ...
                <table id="example1" class="table" style="min-width:100%;">
                  <thead>
                    <tr>
                      ...
                      <th>Gambar Sistem Operasi</th>
                      <!-- <th>Pengenalan Perusahaan</th> -->
                      <th>Visi Perusahaan</th>
                      <!-- <th>Isi Visi Perusahaan</th> -->
                      <th>Misi Perusahaan</th>
                      <!-- <th>Isi Misi Perusahaan</th> -->
                      <th>Action</th>
                    </tr>
                  </thead>
                  <tbody></tbody>
