      ...
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="status_pernikahan" id="status_pernikahan" placeholder="Status Pernikahan" value="<?php echo $status_pernikahan; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="bidang_industri_pekerjaan" id="bidang_industri_pekerjaan" placeholder="Bidang Industri Pekerjaan" value="<?php echo $bidang_industri_pekerjaan; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="tipe_tempat_tinggal" id="tipe_tempat_tinggal" placeholder="Tipe Tempat Tinggal" value="<?php echo $tipe_tempat_tinggal; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="kartu_provider" id="kartu_provider" placeholder="Kartu Provider" value="<?php echo $kartu_provider; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="jumlah_keluarga" id="jumlah_keluarga" placeholder="Jumlah Keluarga" value="<?php echo $jumlah_keluarga; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="jumlah_pendapatan_perbulan" id="jumlah_pendapatan_perbulan" placeholder="Jumlah Pendapatan Perbulan" value="<?php echo $jumlah_pendapatan_perbulan; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="jumlah_pendapatan_keluarga_perbulan" id="jumlah_pendapatan_keluarga_perbulan" placeholder="Jumlah Pendapatan Keluarga Perbulan" value="<?php echo $jumlah_pendapatan_keluarga_perbulan; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="rekening_bank" id="rekening_bank" placeholder="Rekening Bank" value="<?php echo $rekening_bank; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="mobil_yang_dimiliki" id="mobil_yang_dimiliki" placeholder="Mobil Yang Dimiliki" value="<?php echo $mobil_yang_dimiliki; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="motor_yang_dimiliki" id="motor_yang_dimiliki" placeholder="Motor Yang Dimiliki" value="<?php echo $motor_yang_dimiliki; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="hp_yang_dimiliki" id="hp_yang_dimiliki" placeholder="Hp Yang Dimiliki" value="<?php echo $hp_yang_dimiliki; ?>" />
                </div>
              </div>
