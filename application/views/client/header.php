...
<!-- Mirrored from nusaresearch.net/public/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Aug 2021 05:06:40 GMT -->
...
<meta name="description" content="Ikuti survei online dan kumpulkan poinnya. Dapatkan pulsa, paypal dan shopping voucher setiap bulan!" /><title>Nusaresearch - Penelitian Pasar Online di Indonesia</title><link href="https://nusaresearch.net/min/b=application/templates/default/default/css&amp;f=1-reset.css,2-base.css,3-layout.css,5-top.css,6-diapo.css,7-inpage.css,8-jquery.fancybox-1.3.4.css,9-popup-login.css&amp;v=20180924" media="screen" rel="stylesheet" type="text/css" />
<link href="css/popupApp4a61.css?v=20170616" media="screen" rel="stylesheet" type="text/css" /><script type="text/javascript" src="https://nusaresearch.net/min/b=application/templates/default/default/js&amp;f=1-jquery-2.2.4.min.js,jquery-migrate-1.4.1.js,2-init.js,3-jquery.slidescroll.js,4-heightLine.js,5-jquery.easing.1.3.js,6-jquery.hoverIntent.minified.js,7-diapo.js,8-vinaresearch.js,9-jquery.fancybox-1.3.4.js,10-signin.js&amp;v=20180924"></script>
<script type="text/javascript" src="<?php echo base_url()?>assetsPublic/min/b%3dpublic%26f%3djs/slidebar.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assetsPublic/js/popupapp.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assetsPublic/jquery.cookie.js"></script>        
<meta property="og:title" content="Survey Sehat - Survei Online No. 1 di Indonesia" />
    ...
    // Trieu An : Start of Live Chat Script
    window.$zopim||(function(d,s){var z=$zopim=function(c){z._.push(c)},$=z.s=
    d.createElement(s),e=d.getElementsByTagName(s)[0];z.set=function(o){z.set.
    _.push(o)};z._=[];z.set._=[];$.async=!0;$.setAttribute('charset','utf-8');
    $.src='http://v2.zopim.com/?2NFoHKRUEmFtLs5EmxVBschwyQ6KSSdO';z.t=+new Date;$.
...
ga('set', 'dimension1', '182.253.193.82');
...
<div id="wrapper" role="wrapper">
  <div id="header" role="header">
    <div class="header__inner clearfix">
        <h1 id="logo" role="logo"><a href="index.html">
            <img src="<?php echo base_url()?>image/logo.png" height="50" width="256" alt="Nusaresearch - Top Online Research in Vietnam" /></a></h1>
    ...
    <div id="g-navi">
        <div class="g-navi__inner clearfix">
                ...
                <div class="g-navi__link clearfix">
                    <ul class="g-navi__link clearfix">
                        ...
                        <li><a href="javascript:void(0);">Aktivitas</a>
                            <ul class="sub-navi">
                                <li><a href="index/index/redirect/_public_index_resultqquestion.html">Hasil Survei Cepat</a></li>
                                <li class="last"><a href="king-survey/index.html">King of Survey</a></li>
                            </ul>
                        </li>
            ...
            <p id="search-btn"><img src="<?php echo base_url()?>image/default/images/common/search_icon.png" width="16" height="16" alt="" /></p>
            </div>
            <div class="g-navi__search clearfix">
                <form action="https://nusaresearch.net/public/news/index/search" method="get">
                    <input id="" name="txtSearch" class="g-navi__search__input" type="text" placeholder="Search">
                </form>
                <p id="close-btn"><img src="<?php echo base_url()?>image/default/images/common/close_btn02.png" width="16" height="16" alt="" /></p>
            </div>
        </div>
    </div><!-- / id g-navi -->
    </div><!-- / id header -->
