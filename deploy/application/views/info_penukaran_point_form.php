      ...
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="daftar_untuk_penukaran_point" id="daftar_untuk_penukaran_point" placeholder="Daftar Untuk Penukaran Point" value="<?php echo $daftar_untuk_penukaran_point; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="konfirmasi_penukaran" id="konfirmasi_penukaran" placeholder="Konfirmasi Penukaran" value="<?php echo $konfirmasi_penukaran; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="batas_akhir_konfirmasi" id="batas_akhir_konfirmasi" placeholder="Batas Akhir Konfirmasi" value="<?php echo $batas_akhir_konfirmasi; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="pengiriman" id="pengiriman" placeholder="Pengiriman" value="<?php echo $pengiriman; ?>" />
                </div>
              </div>
