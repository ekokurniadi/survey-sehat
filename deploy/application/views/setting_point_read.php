      ...
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="id_setting" id="id_setting" placeholder="Id Setting" value="<?php echo $id_setting; ?>" readonly />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="jumlah_point" id="jumlah_point" placeholder="Jumlah Point" value="<?php echo $jumlah_point; ?>" readonly />
                </div>
              </div>
