...
<div class="modal fade" id="UploadSurvey" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Upload Data Survey</h5>
  ...
  $('#submitBtn').click(function() {
    if ($('#userfile').val() == "") {
      ...
      $.ajax({
        ...
        url: '<?= base_url('survey/upload_survey_action') ?>',
        type: "POST",
        data: values,
        processData: false,
        contentType: false,
