      ...
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="approved_date" id="approved_date" placeholder="Approved Date" value="<?php echo $approved_date; ?>" readonly />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="approved_by" id="approved_by" placeholder="Approved By" value="<?php echo $approved_by; ?>" readonly />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="jenis_penukaran" id="jenis_penukaran" placeholder="Jenis Penukaran" value="<?php echo $jenis_penukaran; ?>" readonly />
                </div>
              </div>
